...
public class MUndirectedNetwork<V, E extends MoreEdge<V>>
	extends UndirectedSparseGraph<V, E> implements MoreNetwork<V, E> {
	...
	public MUndirectedNetwork(MoreEdgeFactory<V, E> edgeFactory, String name) {
	...
	public static <V, E extends MoreEdge<V>> MUndirectedNetwork<V, E> getNewNetwork(MoreEdgeFactory<V, E> edgeFactory,
			UndirectedGraph<V, E> graph, String name) {
		MUndirectedNetwork<V, E> net = new MUndirectedNetwork<V, E>(edgeFactory, name);
	...
	public E connect(V source, V target) {
		...
		E edge = edgeFactory.createEdge(source, target, false);
	...
	public MoreNetwork<V, E> getGraphFilteredInstance(Graph<V, E> graph, String newName) {
		MUndirectedNetwork<V, E> subnet = new MUndirectedNetwork<V, E>(edgeFactory, newName);
		for (V v : graph.getVertices()) {
	...
	public String getNetworkInfo() {
		...
		buffer.append("Directedness: " + (this.isDirected() ? " Directed" : "Undirected") + System.getProperty("line.separator"));
