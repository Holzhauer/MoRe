...
public class MMilieuNetworkParameterMap extends
	...
	public int getK(int milieu) {
		return ((Integer) this.get(new Integer(milieu)).get(
				MilieuNetworkParameterKeys.K.name())).intValue();
	}
	...
	public void setK(int milieu, int k) {
		...
		this.get(new Integer(milieu)).put(MilieuNetworkParameterKeys.K.name(),
				new Integer(k));
	}

	public double getP_Rewire(int milieu) {
		return ((Double) this.get(new Integer(milieu)).get(
				MilieuNetworkParameterKeys.P_REWIRE.name())).doubleValue();
	}
	...
	public void setP_Rewire(int milieu, double p) {
		...
		this.get(new Integer(milieu)).put(
				MilieuNetworkParameterKeys.P_REWIRE.name(), new Double(p));
	}

	public double getSearchRadius(int milieu) {
		return ((Double) this.get(new Integer(milieu)).get(
				MilieuNetworkParameterKeys.SEARCH_RADIUS.name())).doubleValue();
	}
	...
	public void setSearchRadius(int milieu, double radius) {
		...
		this.get(new Integer(milieu)).put(
				MilieuNetworkParameterKeys.SEARCH_RADIUS.name(),
				new Double(radius));
	}

	public double getXSearchRadius(int milieu) {
		return ((Double) this.get(new Integer(milieu)).get(
				MilieuNetworkParameterKeys.X_SEARCH_RADIUS.name()))
				.doubleValue();
	}
	...
	public double getMaxSearchRadius(int milieu) {
		return ((Double) this.get(new Integer(milieu)).get(
				MilieuNetworkParameterKeys.MAX_SEARCH_RADIUS.name()))
				.doubleValue();
	}
	...
	public double getDimWeightGeo(int milieu) {
		return ((Double) this.get(new Integer(milieu)).get(
				MilieuNetworkParameterKeys.DIM_WEIGHTS_GEO.name()))
				.doubleValue();
	}
	...
	public double getDimWeightMilieu(int milieu) {
		return ((Double) this.get(new Integer(milieu)).get(
				MilieuNetworkParameterKeys.DIM_WEIGHTS_MILIEU.name()))
				.doubleValue();
	}
	...
	public double getP_Milieu(int ownMilieu, int otherMilieu) {
		return ((Map<Integer, Double>) this.get(new Integer(ownMilieu)).get(
				MilieuNetworkParameterKeys.P_MILIEUS.name())).get(
	...
	public void setP_Milieu(int ownMilieu, int otherMilieu, double p) {
		...
		if (!this.get(new Integer(ownMilieu)).containsKey(
				MilieuNetworkParameterKeys.P_MILIEUS.name())) {
			this.get(new Integer(ownMilieu)).put(
					MilieuNetworkParameterKeys.P_MILIEUS.name(),
					new HashMap<Integer, Double>());
		}
		((Map<Integer, Double>) this.get(new Integer(ownMilieu)).get(
				MilieuNetworkParameterKeys.P_MILIEUS.name())).put(new Integer(
