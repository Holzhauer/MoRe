 ...
 *
 */
public enum MNetworkBuildingParam implements PmParameterDefinition {
	...
	MNetworkBuildingParam(Class<?> type) {
		this(type, null);
	}

	MNetworkBuildingParam(Class<?> type, Object defaultValue) {
		this.type = type;
