...
public class MCentralityNodeMSupplier extends MAbstractMeasureSupplier {
	...
	private void addMeasures() {
		...
		measures.put(description, new MAbstractNodeMeasure(description, Double.class) {
			public <V extends MoreNodeMeasureSupport, E> MoreAction getAction(final MoreNetwork<V, E> network,
					Map<String, Object> parameters) {
				return new MAbstractAction(MScheduleParameters.getUnboundedRandomMScheduleParameters((Double) parameters
