 ...
 *
 */
public class MGCompleteNetworkBuilder<AgentType, EdgeType extends MoreEdge<AgentType>,
	 ...
	 * @param eFac
	 */
	public MGCompleteNetworkBuilder(NetworkType network, MoreEdgeFactory<AgentType, EdgeType> eFac, String name) {
		super(eFac);
	 ...
	 * @param eFac
	 */
	public MGCompleteNetworkBuilder(NetworkType network, MoreEdgeFactory<AgentType, EdgeType> eFac) {
