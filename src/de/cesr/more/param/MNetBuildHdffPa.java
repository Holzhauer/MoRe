...
public enum MNetBuildHdffPa implements PmParameterDefinition {
	...
	/**
	 * Initialiser for hexagon shapes. Also determines whether a single hexagon layer is applied or
	 * two layers of hexagons are used.
	 */
	HEXAGON_INITIALISER_CLASS(String.class, "de.cesr.more.rs.geo.util.MGeoHexagon$MGeoHexagonInitialiser"),
	...
	/**
	 * Shapes for 2nd layer (see {@link this#HEXAGON_SHAPEFILE}
	 */
