library(ggplot2)
path = "C:/Users/holzhauer/workspace/MORe/logs/linearLocal"
fileNameRandom = "LinearLocalWeibullDistribution_random.csv"
fileNameDensity = "LinearLocalWeibullDistribution_density.csv"
fileNameCumulativ = "LinearLocalWeibullDistribution_cumulativ.csv"
fileNameInverse = "LinearLocalWeibullDistribution_inverse.csv"
